...
#pragma compile(FileVersion, 3.7)
...
;Get SAV Version
Global $curSAVver = "12.1.7004.6500"
...
Func stageOne() ;Creates the base UI, nothing special about it except contact info and instructions.
   ...
   Else
	  GUICtrlSetData($bodyText, GUICtrlRead($bodyText) & @CRLF & "" & @CRLF & "Symantec is up to date.")
   EndIf
